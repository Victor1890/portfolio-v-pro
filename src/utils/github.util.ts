import { IContributionCalendar, IWeek } from '@provider/github/github.interface'
...
export function calculateMostProductiveDayOfWeek(
	...
	const contributionCountByDayOfWeek = calculateContributionCountByDayOfWeek(contributionCalendar.weeks, daysOfWeek)
...
function calculateContributionCountByDayOfWeek(weeks: IWeek[], daysOfWeek: string[]): Record<string, number> {
