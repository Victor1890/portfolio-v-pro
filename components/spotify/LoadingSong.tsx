	...
	return (
		<>
			{Array.from(Array(10).keys()).map((item) => (
				<div
					key={item}
					className='xs:pl-16 relative flex h-[80.8px] items-center  gap-5  overflow-hidden border-b border-l border-r  border-gray-300 bg-gray-100 p-4 font-barlow first:h-[81.6px] first:border-t dark:border-neutral-600 dark:bg-darkPrimary md:h-[84.8px] md:!pl-20 first:md:h-[85.6px] '
				>
