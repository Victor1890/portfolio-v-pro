		...
		>
			...
			<defs>
				...
				>
					...
					<feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_745_19' />
					<feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_745_19' result='shape' />
				</filter>
			</defs>
		</svg>
	)
