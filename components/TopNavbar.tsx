...
export default function TopNavbar() {
	...
	return (
		<div
			className='fixed top-0 z-50 flex w-full items-center justify-between px-4 py-[10px] dark:text-white print:hidden sm:px-6'
			ref={navRef}
		>
...
const MobileMenu = ({ links, handleClick }: { links: string[]; handleClick: () => void }) => {
	return (
		<motion.div
			className='absolute top-0 left-0 z-10 h-screen w-screen bg-white font-normal dark:bg-darkPrimary sm:hidden'
